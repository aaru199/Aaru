...
bot = telebot.TeleBot('7492971015:AAGsGI-tkq5vDSWLRMRSDf35yk_4diksEY4')
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰree me lene aaye ho kya script 🙇."
    bot.reply_to(message, response)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙞𝙨 𝙤𝙣𝙡𝙮 𝙛𝙤𝙧 𝙥𝙖𝙞𝙙 𝙪𝙨𝙚𝙧𝙨 𝙗𝙪𝙮 𝙣𝙤𝙬 𝙛𝙧𝙤𝙢 - @aaru_hamster \n https://t.me/ddosserverfreezbyaaru"
        bot.reply_to(message, response)
